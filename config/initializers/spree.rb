...
Spree.config do |config|
  ...
  # config.roles.assign_permissions :manager, ['Spree::PermissionSets::CustomPermissionSet']
  # config.roles.assign_permissions :cashier, ['Spree::PermissionSets::CustomPermissionSet']
